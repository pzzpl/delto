...
import com.contempt.common.PicUploadResult;
import com.contempt.service.PropertyService;
...
public class PicUploadController {
	...
	//spring父子容器 value注解对.property文件的读取
	@Autowired
	private PropertyService proertyService;
	...
	public String upload(@RequestParam("uploadFile") MultipartFile uploadFile , HttpServletResponse response) throws Exception {
		...
		// 生成图片的绝对引用地址
		String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath,proertyService.REPOSITORY_URL), "\\", "/");
		fileUploadResult.setUrl(proertyService.IMAGE_BASE_URL + picUrl);
	...
	private String getFilePath(String sourceFileName) {
		String baseFolder = proertyService.REPOSITORY_URL + File.separator + "images";
